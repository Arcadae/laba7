...
def generate_matches():
    try:
        ...
        output_text.delete(1.0, tk.END)
        output_text.insert(tk.END, "Пожалуйста, введите числа согласно условиям: Дней должно быть больше 3 и игроков больше 3 (Имеет хоть какой-то логический смысл).")
